...
//        case 'E':                                       /* 2019/ VT52 of ORION-128:  CLS (àíàëîã 0C) */
	...
	case ')': SetConsoleTextAttribute( hConOut, w32_attr() & ~8); break;
	case 't':
        case 'K':                                       /* 2019/ VT52 of ORION-128: ñòèðàíèå äî êîíöà ñòðîêè (âêë-ÿ ïîçèöèþ êóðñîðà) */
	case 'T': w32_clrln( 0); break;
        case 'J':                                       /* 2019/ VT52 of ORION-128: ñòèðàíèå äî êîíöà ýêðàíà (âêëþ÷àÿ ïîçèöèþ êóðñîðà) */
